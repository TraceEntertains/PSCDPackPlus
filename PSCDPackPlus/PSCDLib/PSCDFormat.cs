...
using System.Text;
using System.IO;
using PSCDPackPlus.Compression;
using PSCDPackPlus.PSCDLib.Enums;

namespace PSCDPackPlus.PSCDLib
{
    /// <summary>
    ...
    public class PSCDFormat : IDisposable
    {
        ...
        public void Load()
        {
            ...
            Array.Resize(ref headerBytes, headerBytes.Length + blob.Length);
        ...
        public void SetImage(byte[] rom, bool flip = true)
        {
            ...
            Array.Resize(ref compRom, (int)ImageCompressedSize);
        ...
        public static void CryptBuffer(byte[] data, int offset, int length, ref uint keyNum, byte[] keyBytes, ref int keyPos)
        {
            ...
            {
                keyNum = keyNum << 3 | keyNum >> 29; // rol keyNum,3
