...
namespace PSCDPackPlus
{
    public partial class MainForm : Form
    {
        ...
        byte[] keyBytes = PSCDFormat.ClassicsKeyBytes;
        ...
        void MainFormLoad(object sender, EventArgs e)
        {
            ...
            comboBox1.DataSource = Enum.GetValues(typeof(CollectionType));
        }
        ...
        void OpenButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    pak = new PSCDFormat(saveFileDialog.FileName, keyBytes);
                    changed = false;
        ...
        void DumpRomButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                extractFileDialog.FileName = Path.ChangeExtension(saveFileDialog.FileName, ".bin");
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.Text == "Gold")
                keyBytes = PSCDFormat.ClassicsGoldKeyBytes;
            else if (comboBox1.Text == "Standard")
                keyBytes = PSCDFormat.ClassicsKeyBytes;
        }
    }
}
